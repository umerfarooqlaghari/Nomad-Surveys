...
namespace Alpha.Api.Migrations
{
    ...
    partial class AlphaSurveysDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alpha.Api.Entities.EmailAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Alpha.Api.Entities.ReportChartImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Alpha.Api.Entities.TenantSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Alpha.Api.Entities.TenantSettings", b =>
                {
                    b.HasOne("Alpha.Api.Entities.Tenant", "Tenant")
                        .WithOne()
                        .HasForeignKey("Alpha.Api.Entities.TenantSettings", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
